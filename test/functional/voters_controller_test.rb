...
class VotersControllerTest < ActionController::TestCase
  ...
  test "should create voter" do
    assert_difference('Voter.count') do
      post :create, voter: { email: @voter.email, votedEver: @voter.votedEver, votedToday: @voter.votedToday }
    end
  ...
  test "should update voter" do
    put :update, id: @voter, voter: { email: @voter.email, votedEver: @voter.votedEver, votedToday: @voter.votedToday }
    assert_redirected_to voter_path(assigns(:voter))
  end
